    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
          DIBF is committed to creating measurable, sustainable impact across
          our core focus areas. Our work is driven by a deep understanding of the
          challenges communities face and a commitment to creating lasting
          change.
        </p>
      </div>
      ...
      <div className="mt-16 text-center bg-slate-50 p-10 rounded-xl">
        ...
        <p className="text-slate-700 max-w-3xl mx-auto mb-6">
          Explore our stories, reports, and publications to learn more about the
          impact we are making together with our partners and supporters.
        </p>
